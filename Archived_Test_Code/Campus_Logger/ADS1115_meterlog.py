...
#  - 2/3 = +/-6.144V 1 bit =
#  -   1 = +/-4.096V 1 bit = 125 uV = 0.125 mV = (4.096 V / 32768)
#  -   2 = +/-2.048V 1 bit =
#  -   4 = +/-1.024V 1 bit =
#  -   8 = +/-0.512V 1 bit =
#  -  16 = +/-0.256V 1 bit =
# GAIN = 2/3
GAIN = 1
bitConversionFactor = 0.125  # mV per bit per the table above
...
# ----------------------------
flowPin = 1                 # Analog port on the ADC to which the meter is connected
