# ----------------------------------------------------------------------
# Defines a class that is used to name the data directory and data files
# Created by: Jeff Horsburgh using code originally written by
# Miguel Leonardo
# ----------------------------------------------------------------------
import re
...
class Filenamer(object):
    """
    Class that is used to name the directory for the output data file
    and the output data file itself
    """
